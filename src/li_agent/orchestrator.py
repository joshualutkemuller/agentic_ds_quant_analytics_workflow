...
class LIOrchestratorAgent:
    """Natural-language orchestrator for SQL -> data prep -> dashboard output."""
    ...
    def run(self, request: UserRequest) -> AgentResponse:
        ...
        plan = QueryPlan(
            ...
            metadata={"mode": "short_term_scaffold", "request": request.prompt, "target": target},
        )
        ...
        report = (
            f"Generated {target} dashboard payload with validated fields. "
