...
description: Coordinate multi-agent analytics execution from natural-language user requests. Use when tasks require routing between SQL querying, data transformation, Tableau/PowerBI dashboard generation, validation, and reporting agents.
---
